    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <p data-aos="fade-up" data-aos-delay="300"><a href="<?= site_url('services') ?>" title="En savoir plus sur les solutions que nous concevons" class="btn btn-primary">Découvrir nos services</a></p>
            </div>
            <?php if (!$isMobile) : ?>
                <div class="col-lg-3">
        ...
        <div class="row">
            <div class="col-lg-3 ms-auto">
                <div class="aside-box" data-aos="fade-up">
                    ...
                    <p data-aos="fade-up" data-aos-delay="300"><a href="<?= site_url('contact') ?>" title="Contactez afrinewsoft" class="btn btn-outline-light-bg has-arrow">Entrez en contact avec nous <span class="icon-keyboard_backspace"></span></a></p>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-sm-12 mt-5 p-2">
                                ...
                                <p data-aos="fade-up" data-aos-delay="200">
                                    Avec beaucoup d'expériences, nos équipes travaillent quotidiennement pour concevoir
                                    des logiciels dans le respect de délai, d'architecture et de normes d'agilité.
                                </p>
                                <p data-aos="fade-up" data-aos-delay="200">
                                ...
                                <p data-aos="fade-up" data-aos-delay="300"><a href="<?= site_url('contact') ?>" title="Pourquoi Afrinewsoft" class="btn btn-outline-light-bg has-arrow">Débutez avec nous
                    ...
                    <?php foreach ($services as $row) : ?>
                        <div class="col-6 col-xs-6 col-md-6 col-lg-3 ico" data-aos="fade-up" data-aos-delay="<?= $row->data_aos_delay ?>">
                            <a href="<?= site_url("services/$row->serviceSlug ") ?>" class="feature" title="Afrinewsoft-<?= $row->serviceName_fr ?>">
                                <?= img('public/assets/images/services/icons/' . $row->serviceImage . '', '', 'alt="Afrinewsoft-<?= $row->serviceName_fr ?>"') ?>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6" data-aos="fade-up">
                    <?= img('public/assets/images/photography.webp', '', 'class="img-fluid"') ?>
                </div>
                <div class="col-lg-6 relative">
                    <div class="box-wrap">
                        <div>
                            <h2 class="heading text-white">Afrinewsoft events</h2>
                            <p class="text-white-50 mb-4">Vous organisez un événement, mais il vous manque une équipe pour la photographie ou le filmage professionnel,
                                eh bien, vous êtes sur le bon endroit, Afrinewsoft dispose des outils professionnels pour la photographie et le filmage ainsi qu'un personnel dynamique et expérimenté pour vous accompagner.</p>
                            <div class="row">
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                                    <div class="service-2">
                                        <?= img('public/assets/images/services/icons/002-couple-de-mariage-1.png', '', 'alt="Meeting Icon" class="mb-1"') ?>
                                ...
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                                    <div class="service-2">
                                    <?= img('public/assets/images/services/icons/005-meeting.png', '', 'alt="Meeting Icon" class="mb-1"') ?>
                                ...
                                <div class="col-lg-6 mt-4" data-aos="fade-up" data-aos-delay="300">
                                    <a title="Afrinewsoft-Contact" href="<?= site_url('contact') ?>" class="btn has-arrow btn-outline-dark-bg">Entrez en contact <span class="icon-keyboard_backspace"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
